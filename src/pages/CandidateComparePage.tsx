...
import { CandidateCompareTool } from '../components/candidate-id-compare/CandidateCompareTool';
      ...
      >
        <div className="space-y-2">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest mb-2 bg-black text-white">
            <Search className='mb-0.5' size={12} />
            <span className='mt-0.5'>Comparison Tool</span>
          </div>
          <h1 className="tracking-tighter leading-none text-5xl font-black">
            Candidate <span className="text-gray-300">ID</span> <span className="text-4xl text-gray-400">Compare</span>
          </h1>
          <p className="font-medium text-gray-500">
            Compare and deduplicate Candidate IDs across different runs.
          </p>
        </div>
        <ToolNavigation />
      </motion.header>
